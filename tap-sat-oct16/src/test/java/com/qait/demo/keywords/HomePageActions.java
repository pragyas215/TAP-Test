...
//		StringBuffer sb = new StringBuffer();
	...
	public void verifyTitleIsDisplayed() {
		Assert.assertTrue(element("link_Title").isDisplayed());
	}
   public void verifySignInIsPresent() {
	   Assert.assertTrue(element("link_SignIn").isDisplayed());
   }
   
   public void verifyCartImageIsPresent(){
	   Assert.assertTrue(element("img_cart").isDisplayed());
   }
}
